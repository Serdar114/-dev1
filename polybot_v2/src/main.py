"""
polybot_v2 Phase 3 - main entry point.

Two-lane paper evaluation system with session verdict tooling:
  Lane 1 (baseline):    Selective Taker Paper Engine
  Lane 2 (primary):     Maker Shadow Evaluation Lane

No real orders are placed. Phase 3 measures whether maker has edge
and produces a rules-based session verdict on shutdown.
"""
