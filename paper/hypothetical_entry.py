...
def record_hypothetical(
    ...
    return HypotheticalEntryEvent(
        ...
        fee_per_unit=up_econ.fee_per_unit,
        effective_cost_per_unit=round(up_econ.entry_price + up_econ.fee_per_unit, 8),
...
def record_both_sides(
    ...
    for side, ask_price in (("Up", features.up_best_ask), ("Down", features.dn_best_ask)):
        ...
        events.append(HypotheticalEntryEvent(
            ...
            fee_per_unit=econ.fee_per_unit,
            effective_cost_per_unit=round(econ.entry_price + econ.fee_per_unit, 8),
